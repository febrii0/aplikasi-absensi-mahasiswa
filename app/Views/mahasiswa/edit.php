    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="/mahasiswa/addMhs" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-4">
                                <input type="hidden" value="<?= $nama["id_mhs"]; ?>" name="npm">
                                <div class="col-md-6">
                                    <label for="nama" class="form-label">Nama</label>
                                    <input type="text"
                                        class="form-control <?= isset($errors['nama']) ? 'is-invalid ' : ''; ?>"
                                        id="nama" name="nama"
                                        value="<?= isset($errors['nama']) ? old('nama') : $mahasiswa["nama"]; ?>">
